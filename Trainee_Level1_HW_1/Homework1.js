...
describe('v5.webdriver.io page', () => {
    ...
    it('Task 2 and 3: should demonstrate the click command and display url of page in the console', async() => {
        await browser.url('https://v5.webdriver.io');
    ...
    it('Task 6,7,8: print "text is" + add "DONE!" and add pause on 5 minutes ', async function () {
        await browser.url('https://v5.webdriver.io');
