...
describe('v5.webdriver.io page', () => {
    ...
    it('should defect if an element is clickable', async() => {
        await browser.url('https://v5.webdriver.io');
    ...
    it('should defect if an element is visible', async() => {
        await browser.url('https://v5.webdriver.io');
    ...
    it('should defect if an element is enabled', async() => {
        await browser.url('https://v5.webdriver.io');
        let isEnabled = await $(blogButton).isEnabled();
        console.log("IS ENABLED BlogButton?:" + isEnabled);
    });
    it('should defect the focus of an element', async() => {
        await browser.url('https://v5.webdriver.io');
    ...
    it('should save a screenshot of the browther view', async function () {
        await browser.url('https://v5.webdriver.io');
